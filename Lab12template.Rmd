...
perm_cor <- function(perms = 1000, x, y)
{
  ...
  # Create vector of zeroes of length "perms" to store
  # permuted mean differnces
  cor_mean_difference <- numeric(perms)
  ...
  for (i in c(1:perms))
  {
    ...
    cor_mean_difference <- cor(x, mix_up)
    
  }
  
  # Step 4:
  # Return new updated vector, created in step 1
    return(cor_mean_difference)
}
```
...
###Questions dont have to be this I thought I would just add a baseline to go off of.

*Question one:

Has life expectancy in Africa changed (precentage-wise) more than the Americas since 1977?

*Question Two:
Does increased GDP per capita grow population?
